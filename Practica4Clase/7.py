...
palabras = [ " C ó ncavo " , " Autopista " , " Diagonal " , " Equipaje " ,
" Ardilla " , " Consultorio " , " Roma " ,
" Loco " , " Marciano " , " Karateca " , " Aniversario " , " Topadora " ,
" Grabador " , " Salir " , " Ventoso " ,
" Anunciar " ," R ó tula " , " Estanque " , " Quedarse " , " Nuevo " ,
" Sordo " , " Madurar " , " Vestir " ,
" Retoque " , " Desvelo " , " Hora " , " Cochera " , " Metal " , " Nudo " ,
" Maquillaje " , " Barco " , " Soda " ,
" Lagartija " ]
...
for i in range(len(palabras) - 1, 0, -1):
    if (palabras[i][0] != "A" or
            palabras[i][0] != "E" or
            palabras[i][0] != "I" or
            palabras[i][0] != "O" or
            palabras[i][0] != "U"):
        print(
            "Seleccionar la última palabra que empiece con una consonante %s"
            % palabras[i]
        )
        break
